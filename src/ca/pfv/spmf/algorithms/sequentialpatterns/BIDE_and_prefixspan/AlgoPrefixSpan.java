...
//					break itemsetLoop;
	...
	public void printStatistics(int size) {
		...
		r.append('\n');
		r.append("===============  PREFIXSPAN - CONFIG ===============\n");
		r.append(" MinSupp : " );
		r.append(new BigDecimal(minsuppAbsolute).divide(new BigDecimal(sizeDatabase)).multiply(new BigDecimal(100)).toString());
		r.append(" ( " + minsuppAbsolute + " / " + sizeDatabase + " ) ");
		r.append('\n');
		r.append(" MaximumPatternLength : " );
		r.append(this.getMaximumPatternLength());
		r.append('\n');
		r.append("===================================================\n");
